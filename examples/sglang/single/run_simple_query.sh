#!/bin/bash
# Simple query test for SGLang server.
# Sends a prompt and prints the completion.
...
echo "=== Response ==="
# Build JSON payload via python to safely escape newlines in PROMPT
