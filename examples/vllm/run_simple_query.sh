#!/bin/bash
# Simple single query test for Maru P2P KV cache sharing (vLLM direct)
...
PORT1="${MARU_INST1_PORT:-13019}"
PORT2="${MARU_INST2_PORT:-13020}"
...
echo "=== inst2 - Maru P2P Retrieve (port ${PORT2}) ==="
send_query "$PORT2"
echo ""
